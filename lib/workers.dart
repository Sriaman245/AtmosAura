   ...
   startApp(loc);
    return Scaffold(
        body: Container(
            ...
            colors: [Color.fromARGB(255, 25, 0, 50),const Color.fromARGB(255, 102, 23, 180),const Color.fromARGB(255, 79, 26, 120), Color(0xff330867)],
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Image.asset('assets/images/weather.png',height:200,width:200),
                  SizedBox(
                    height: 25,
                  ),
                  Text(
